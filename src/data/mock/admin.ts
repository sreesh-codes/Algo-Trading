...
export const INITIAL_SYSTEM_MONITOR: SystemMonitorData = {
  workers: {
    ...
    ramGb: 44.8,
    maxRamGb: 64.0,
    tempMilliKelvin: 14.2, // Cryogenic quantum cluster
  },
  queues: [
    {
  ...
  backtests: {
    ...
    completedToday: 1420,
    avgDurationSec: 8.4,
    peakThroughputPerMin: 180,
  },
  activeUsers: {
    totalSessions: 128,
    algorithmicBots: 24,
    spectatorTerminals: 102,
    activeAdminConsoles: 2,
  },
  errorRate: {
    ratePercent: 0.002,
    errorsLastHour: 3,
    ...
    recentIncidents: [
      "14:22:10 GST — Gateway router #2 dropped 1 non-standard FIX frame (Malformed tag 35).",
      "13:58:12 GST — Sandbox node #07 garbage collector pause: 1.8ms (recovered).",
      "13:10:04 GST — Spectator websocket reconnect burst: 14 clients gracefully re-synced.",
    ],
  },
};
